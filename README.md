...
- Your experiment figures for direct visualization in this page.

## Implementation Notice
- The Python implementation in this repository was generated with AI assistance.
- For algorithm details, behavior, and final reproducible reference, please follow the MATLAB code in this repository.
...
## Method Overview
<p align="center">
  <img src="assets/figures/pipeline.png" alt="pipeline" width="100%" />
</p>
...
<p align="center">
  <img src="assets/figures/synthetic_results.png" alt="synthetic results" width="100%" />
</p>

<p align="center">
  <img src="assets/figures/noise_pic.png" alt="noise robustness visualization" width="100%" />
</p>

<p align="center">
  <img src="assets/figures/noise_f1.png" alt="noise F1 curves" width="100%" />
</p>
...
## Notes
- Main figures are loaded from `assets/figures/pipeline.png`, `assets/figures/synthetic_results.png`, `assets/figures/noise_pic.png`, and `assets/figures/noise_f1.png`.
- Python labels are 1-based to match MATLAB outputs.
- Python code is AI-generated; MATLAB implementation is the authoritative reference.
